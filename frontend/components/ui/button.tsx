  ...
  "inline-flex items-center justify-center px-3 border rounded-md gap-1.5 whitespace-nowrap cursor-pointer disabled:opacity-50 [&[inert]]:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        "floating-action":
          "fixed right-4 bottom-18 z-30 rounded-full border-blue-600 bg-blue-600 text-white shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1),0px_1px_3px_0px_rgba(0,0,0,0.1)] hover:border-blue-500 hover:bg-blue-500 disabled:pointer-events-auto",
      },
      size: {
        default: "py-2",
        small: "py-1.25",
        icon: "size-10",
        "icon-lg": "size-14 p-0 [&_svg]:size-6",
      },
    },
    defaultVariants: {
      variant: "default",
