          ...
          {isForeignUser ? (
            <>
              <div>
                ...
                confirm your taxpayer status. If you're eligible for 1042-S forms, you'll receive an email with a
                download link once available.
              </div>
            ...
            <>
              <div>
                ...
                your taxpayer status. If you're eligible for 1099 forms, you'll receive an email with a download link
                once available.
              </div>
              <div className="flex gap-1">
                <ArrowTopRightOnSquareIcon className="size-4" />
          ...
          <div className="prose h-[25em] overflow-y-auto rounded-md border p-4">
            ...
            {isForeignUser ? (
              <>
                ...
                <br />
                (d) the partner's amount realized from the transfer of a partnership interest subject to withholding
                ...
                custody of the income of which the {foreignEntityTitle} named on line 1 or any withholding agent that
                can disburse or make payments of the income of which the {foreignEntityTitle} named on line 1. <br />
                <br />I agree that I will submit a new form within 30 days if any certification made on this form
                becomes incorrect.
              </>
            ) : (
              <>
