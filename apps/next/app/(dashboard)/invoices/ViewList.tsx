...
import EquityPercentageLockModal from "@/app/(dashboard)/invoices/EquityPercentageLockModal";
import { StatusWithTooltip } from "@/app/(dashboard)/invoices/Status";
import DataTable, { createColumnHelper, useTable } from "@/components/DataTable";
import DurationInput from "@/components/DurationInput";
import Input from "@/components/Input";
// Using dashboard layout instead of MainLayout
